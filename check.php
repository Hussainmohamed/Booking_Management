...
<head>
    ...
    $(document).ready(function() {
     var calendar = $('#calendar').fullCalendar({
      editable:true,
      eventSources:'http://localhost/Book/display.php',
      selectable:true,
      selectHelper:true,    
      header:{
       left:'prev',
      ...
      select:function(start,end){
          $('#calendar').val(start.format());
          var start=moment(start).format("Y-MM-DD"); 
          var end=moment(end).format("Y-MM-DD"); 
          $.post("display.php",{Startdate:start,Enddate:end},function(data){
             if(data==1){
