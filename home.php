...
<body>
            ...
            <div class="top-right">
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        ...
                        <?php echo substr($_SESSION['username'],0,strpos($_SESSION['username'],"@")); ?><i class="fa fa-user act" style="font-size:45px;margin-right:23px;"></i>
                        </a>
 ...
 $res=$con->query("select count(title) as cnt from booking");
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text">$<span class="count"><?php echo $row['cnt']; ?></span></div>
